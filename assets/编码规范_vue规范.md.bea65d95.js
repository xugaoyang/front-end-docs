import{_ as s,o as n,c as a,O as l}from"./chunks/framework.865a7308.js";const A=JSON.parse('{"title":"vue规范","description":"","frontmatter":{},"headers":[],"relativePath":"编码规范/vue规范.md","filePath":"编码规范/vue规范.md"}'),p={name:"编码规范/vue规范.md"},o=l(`<h1 id="vue规范" tabindex="-1">vue规范 <a class="header-anchor" href="#vue规范" aria-label="Permalink to &quot;vue规范&quot;">​</a></h1><ul><li>组件名为多个单词</li></ul><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// bad</span></span>
...
<span class="line"><span style="color:#89DDFF;">/&gt;</span></span></code></pre></div>`,23),t=[o];function e(c,D,F,r,y,i){return n(),a("div",null,t)}const u=s(p,[["render",e]]);export{A as __pageData,u as default};
